...
export default () => {
  ...
  return (
    <div className={styles.terms}>
      ...
      <p>
        <strong>本软件尊重并保护所有使用服务用户的个人隐私权。</strong>
        为了给您提供更准确、更有个性化的服务，本软件会按照本隐私权政策的规定使用和披露您的个人信息。但本软件将以高度的勤勉、审慎义务对待这些信息。除本隐私权政策另有规定外，在未征得您事先许可的情况下，本软件不会将这些信息对外披露或向第三方提供。本软件会不时更新本隐私权政策。
        <strong>
